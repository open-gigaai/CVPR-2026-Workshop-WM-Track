...
fps = 16
project_dir="/shared_disk/users/yukun.zhou/experiments/control_world/0303_mixed_task3_infer/"
config = dict(
    project_dir=project_dir,
    runners=["control_world.CWRolloutMixedTrainerV2"],
    launch=dict(
    ...
    dataloaders=dict(
        train=dict(
            data_or_config=[
                "/shared_disk/users/yukun.zhou/dataset/action_conditional/gigaworld-1/task3-infer/train",
            ],
            ...
            filter=dict(
                mode='overall_func',
                func='configs.1119_cw_task2.filter_data',
                dst_size=dst_size,
